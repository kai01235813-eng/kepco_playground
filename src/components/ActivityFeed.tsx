              ...
              >
                <div className="flex flex-1 flex-col">
                  <span className="text-[11px]">
                    ...
                    <span className="font-semibold text-sky-300">"{activity.post_title}"</span>에{' '}
                    <span className={activity.vote_type === 'upvote' ? 'text-emerald-300' : 'text-rose-300'}>
                      {activity.vote_type === 'upvote' ? '찬성' : '반대'}
                    </span>
                    투표하여{' '}
                    <span className="font-semibold text-emerald-200">
                      KEP코인 {activity.coins_earned}개
                    </span>{' '}
                    획득
                  </span>
                </div>
